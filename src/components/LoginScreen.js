...
const LoginScreen = () => {
  ...
  return (
    ...
    : <Form style={{width: "100%", alignSelf: "center", display: "flex", justifyContent: "center"}} onSubmit={loginWithEmailPassword}>
      <Grid style={{width: "50vw", minWidth: "300px"}}>
        ...
        <Grid.Row columns={2}>
          <Grid.Column>
            <Button size="large" disabled={!formValid} type="submit" fluid primary>Login</Button>
          </Grid.Column>
          <Grid.Column>
            <Button size="large" type="button" fluid onClick={loginWithGoogle}>Log in with Google</Button>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column>
            <Link to="/signUp">
              <Button size="small" type="button" fluid primary>Sign Up</Button>
            </Link>
          </Grid.Column>
        </Grid.Row>
      </Grid>
